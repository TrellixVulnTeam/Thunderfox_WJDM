...
/*
 * Migrates from a Thunderfox profile in a lossy manner in order to clean up a
...
function ThunderfoxProfileMigrator() {
  this.wrappedJSObject = this; // for testing...
}

ThunderfoxProfileMigrator.prototype = Object.create(MigratorPrototype);

ThunderfoxProfileMigrator.prototype._getAllProfiles = function() {
...
ThunderfoxProfileMigrator.prototype.getSourceProfiles = function() {
  return [...this._getAllProfiles().keys()]
    .map(x => ({ id: x, name: x }))
    .sort(sorter);
};

ThunderfoxProfileMigrator.prototype._getFileObject = function(dir, fileName) {
  let file = dir.clone();
...
ThunderfoxProfileMigrator.prototype.getResources = function(aProfile) {
...
ThunderfoxProfileMigrator.prototype.getLastUsedDate = function() {
...
ThunderfoxProfileMigrator.prototype._getResourcesInternal = function(
  sourceProfileDir,
  currentProfileDir
) {
...
Object.defineProperty(ThunderfoxProfileMigrator.prototype, "startupOnlyMigrator", {
    get: () => true,
});

ThunderfoxProfileMigrator.prototype.classDescription = "Thunderfox Profile Migrator";
ThunderfoxProfileMigrator.prototype.contractID =
  "@mozilla.org/profile/migrator;1?app=browser&type=thunderfox";
ThunderfoxProfileMigrator.prototype.classID = Components.ID(
  "{91185366-ba97-4438-acba-48deaca63386}"
);

var EXPORTED_SYMBOLS = ["ThunderfoxProfileMigrator"];
